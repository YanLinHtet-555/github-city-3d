...
_skyGrad.addColorStop(0.00, '#0e0618');
_skyGrad.addColorStop(0.38, '#2a0c3a');
_skyGrad.addColorStop(0.62, '#6a1a18');
_skyGrad.addColorStop(0.80, '#c43a0e');
_skyGrad.addColorStop(1.00, '#ff7722');
...
// ── Tracked blink meshes + rooftop anims ─────────────────────────────────────
let _blinkMeshes = [];
let _roofAnims = [];
